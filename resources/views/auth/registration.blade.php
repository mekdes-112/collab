...
<head>
  ...
  <title>Mezgebu Registration page</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
  <link rel="stylesheet" href= "file:///C:/xampp/htdocs/mezgebu/resources/css/signup.css">
</head>

<body id="body">
  <nav id="logo">
    <a href=""><img src="C:\Users\63\Desktop\Group 103.svg" alt="">
  </nav>
  ...
  <div class="center">
    <h4> SignUp</h4>
    <form action="{{route('regitser-user')}}" method="post">
      ...
      @csrf
      <div class="txt_field">
        <input type="text" name="username" value="{{old('name')}}" required>
        <span></span>
        <label  id="enter" for="username">Enter username </label>
      ...
      <div class="txt_field">
        ...
        <span></span>
        <label  id="enter" for="email">Enter email </label>
        <span class="text-danger">@error('email') {{$message}} @enderror</span>
      </div>
      <div class="txt_field">
        <input type="password" name="password" value="{{old('password')}}" required>
        <span></span>
        <label id="enter" for="password">Enter password</label>
      ...
      <div class="txt_field">
        ...
        <span></span>
        <label id="enter" for="cpassword">Confirm password</label>
  ...
  <div>
    <img id="team"src="C:\Users\63\Desktop\teamwork.svg" alt="">
  </div>
